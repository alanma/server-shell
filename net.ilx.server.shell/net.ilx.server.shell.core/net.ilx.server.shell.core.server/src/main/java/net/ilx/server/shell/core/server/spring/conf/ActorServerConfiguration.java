...
import net.ilx.server.shell.core.server.spring.components.AApplication;
...
public class ActorServerConfiguration implements EnvironmentAware {
    ...
    public AApplication application() {
        int shutdownTimeout = env.getProperty("net.ilx.server.shell.core.server.spring.components.AApplication.shutdownTimeout", Integer.class, 60);
