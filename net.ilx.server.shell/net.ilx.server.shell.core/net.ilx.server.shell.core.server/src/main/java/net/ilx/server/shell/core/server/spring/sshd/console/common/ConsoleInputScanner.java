...
import net.ilx.server.shell.core.server.spring.sshd.console.completion.CompletionHandler;
...
public class ConsoleInputScanner extends Scanner {
    ...
    private void sendQuitToConsole() throws IOException {
    	// net.ilx.server.shell.core.server.spring.sshd.console.ssh.Console.getLine(String)
    	newChar(4);
    	newChar(CR);
    	processData();
	}
