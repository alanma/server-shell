 ...
 * under the License.
 */
package net.ilx.server.shell.core.server.spring.sshd.runtime;
...
import net.ilx.server.shell.core.server.spring.sshd.command.Converter;
import net.ilx.server.shell.core.server.spring.sshd.command.Function;
import net.ilx.server.shell.core.server.spring.sshd.runtime.api.CommandSessionListener;
...
public class CommandProcessorImpl implements CommandProcessor
{
    ...
    {
    	LOG.trace("Getting command '{}' within path '{}'", name, path);
