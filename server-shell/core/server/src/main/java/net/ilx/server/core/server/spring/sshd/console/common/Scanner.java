	package net.ilx.server.core.server.spring.sshd.console.common;
...
import net.ilx.server.core.server.spring.sshd.console.common.terminal.ANSITerminalTypeMappings;
import net.ilx.server.core.server.spring.sshd.console.common.terminal.SCOTerminalTypeMappings;
import net.ilx.server.core.server.spring.sshd.console.common.terminal.TerminalTypeMappings;
import net.ilx.server.core.server.spring.sshd.console.common.terminal.VT100TerminalTypeMappings;
import net.ilx.server.core.server.spring.sshd.console.common.terminal.VT220TerminalTypeMappings;
import net.ilx.server.core.server.spring.sshd.console.common.terminal.VT320TerminalTypeMappings;
